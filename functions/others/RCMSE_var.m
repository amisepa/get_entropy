function Out_RCMSE = RCMSE_var(x,m,r,tau,Scale)
%
%  This function calculates the refined composite multiscale sample entropy (RCMSE) whose coarse-graining uses variance (RCMSE_var)
%
%
% Inputs:
%
...
% Outputs:
%
% Out_RCMSE: a vector showing the RCMSE_var of x
%
% Ref:

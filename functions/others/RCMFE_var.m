function Out_RCMFE = RCMFE_var(x,m,r,n,tau,Scale)
%
%  This function calculates the refined composite multiscale fuzzy entropy (RCMFE) whose coarse-graining uses variance (RCMFE_var)
%
%
% Inputs:
%
...
% Outputs:
%
% Out_RCMFE: a vector showing the RCMFE_var of x
%
% Ref:

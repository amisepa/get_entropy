function Out_MFE=MFE_std(x,m,r,n,tau,Scale )
%
%  This function calculates the multiscale fuzzy entropy (MFE) whose coarse-graining uses standard deviation (MFE_std)
%
%
% Inputs:
%
...
% Outputs:
%
% Out_MFE: a vector showing the MFE_std of x
%
% Ref:
